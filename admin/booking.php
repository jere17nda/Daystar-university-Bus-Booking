                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="button delete-button btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal" data-id="<?php
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Welcome..., Book your seat with us</h5>
                ...
                <div class="modal-body">
                    <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="sourceSearch" class="form-label">Departure</label>
                            <!-- Search Functionality -->
                            <div class="searchQuery">
