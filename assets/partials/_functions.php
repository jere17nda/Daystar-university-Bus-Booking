...
function exist_buses($conn, $busno, $Capacity, $Driver, $Conductor, $Phone_Number)
{
    $sql = "SELECT * FROM `buses` WHERE bus_no='$busno' AND Capacity= '$Capacity' AND Driver='$Driver' AND Conductor='$Conductor' AND Phone_Number='$Phone_Number'";
