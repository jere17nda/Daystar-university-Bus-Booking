...
<div class="container">
        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <address>
                        <strong>DAYSTAR UNIVERSITY SHUTTLE</strong>
                        <br>
                        P.O. Box 17,Daystar University 90145, Athi-River
                        <br>
            ...
            <div class="row">
                <div class="text-center">
                    <br>
                    <h4><b>TICKET CODE:</b> <?php echo $pnr; ?></h5>
                    <br>
                </div>
                </span>
    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 0vh;">    
